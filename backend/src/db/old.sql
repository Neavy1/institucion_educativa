...
//! TODO: REVISAR Y APUNTAR QUÉ RECIBE Y QUÉ RETORNA
-- 5. total de estudiantes matriculados en un periodo académico
...
//! TODO: REVISAR Y APUNTAR QUÉ RECIBE Y QUÉ RETORNA
-- 6. total de estudiantes matriculados en un programa académico
SELECT COUNT(DISTINCT m.fk_id_estudiante) AS total_estudiantes
FROM matricula_academica AS m
INNER JOIN oferta_academica AS oa ON m.fk_id_oferta_academica = oa.id_oferta_academica
...
//! TODO: REVISAR Y APUNTAR QUÉ RECIBE Y QUÉ RETORNA
-- 9. creditos matriculados por un estudiante en un periodo académico
...
//! TODO: REVISAR Y APUNTAR QUÉ RECIBE Y QUÉ RETORNA
-- 10. ubicación semestral de un estudiante
...
//! TODO: REVISAR Y APUNTAR QUÉ RECIBE Y QUÉ RETORNA
-- 11. último periodo académico que matriculó un estudiante
